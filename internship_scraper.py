...
class InternshipScraper:
    def __init__(self):
        ...
        self.search_sites = [
            ...
            {
                'name': 'LinkedIn January',
                'url': 'https://www.linkedin.com/jobs/search/?keywords=january%202026%20tech%20internship',
                'parser': self.parse_linkedin
            },
            {
                'name': 'LinkedIn February',
                'url': 'https://www.linkedin.com/jobs/search/?keywords=february%202026%20tech%20internship',
                'parser': self.parse_linkedin
            },
            {
                'name': 'Indeed',
            ...
            {
                'name': 'Indeed January',
                'url': 'https://www.indeed.com/jobs?q=january+2026+software+engineering+internship',
                'parser': self.parse_indeed
            },
            {
                'name': 'Glassdoor',
            ...
            {
                'name': 'Glassdoor January',
                'url': 'https://www.glassdoor.com/Job/software-engineer-january-2026-internship-jobs-SRCH_KO0,38.htm',
                'parser': self.parse_glassdoor
            }
        ]
    ...
    def parse_linkedin(self, html, source_url):
        ...
        for card in job_cards:
            try:
                ...
                if title_elem and company_elem:
                    ...
                    apply_link = apply_link_elem.get('href') if apply_link_elem else source_url
    ...
    def parse_indeed(self, html, source_url):
        ...
        for card in job_cards:
            try:
                ...
                if title_elem and company_elem:
                    ...
                    # Get direct job posting URL
                    apply_link = "https://indeed.com" + apply_link_elem.get('href') if apply_link_elem and apply_link_elem.get('href') else source_url
    ...
    def parse_glassdoor(self, html, source_url):
        ...
        for card in job_cards:
            try:
                ...
                if title_elem and company_elem:
                    ...
                    # Get direct job posting URL
                    apply_link = "https://www.glassdoor.com" + apply_link_elem.get('href') if apply_link_elem and apply_link_elem.get('href') else source_url
    ...
    def scrape_site(self, site):
        ...
        try:
            # Rotate user agents and add longer delay to avoid blocking
            headers = {
            ...
            # Add longer delay before requesting
            time.sleep(random.uniform(5, 8))
            
            response = requests.get(site['url'], headers=headers, timeout=30)
            if response.status_code == 200:
                return site['parser'](response.text, site['url'])
            else:
    ...
    def update_readme(self, internships):
        ...
        for job in sorted_internships:
            # Always use the direct apply link from the job posting
            apply_link = job.get('apply_link', job.get('source_url', ''))
    ...
    def run(self):
        ...
        for site in self.search_sites:
            ...
            # Add longer delay between sites
